...
/**
 * Created by zdns on 16/5/17.
 */
public class DatePickeFragment extends DialogFragment{
    public static final String EXTRA_DATE = "org.niuzuo.criminalintent.date";
    private Date mDate;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(getActivity()).setView(v).setTitle(R.string.date_picke_title).
